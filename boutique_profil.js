...
const SHOP_TITLES = [
  ...
  { id: 'color_blue', name: '🔵 Pseudo Bleu', price: 1000, type: 'color', desc: 'Ton pseudo s\'affiche en bleu' },
  ...
  // ── BANNIÈRES ──────────────────────────────────────
  // Couleurs unies
  { id: 'banner_red',    name: '🟥 Bannière Rouge',   price: 5000,  type: 'banner', bannerClass: 'banner-red',    desc: 'Fond rouge sur ta carte de profil' },
  { id: 'banner_green',  name: '🟩 Bannière Verte',   price: 5000,  type: 'banner', bannerClass: 'banner-green',  desc: 'Fond vert sur ta carte de profil' },
  ...
  { id: 'banner_constellation', name: '✦ Motif Constellation', price: 25000, type: 'banner', bannerClass: 'banner-constellation', desc: 'Fond étoilé comme un ciel nocturne' },
  // Effets animés
  ...
  // Motifs
  { id: 'banner_diagonales', name: '╲ Motif Diagonales', price: 25000, type: 'banner', bannerClass: 'banner-diagonales', desc: 'Lignes diagonales élégantes sur ta carte', hidden: true },
  { id: 'banner_grille_pastel', name: '🎨 Motif Grille Pastel', price: 25000, type: 'banner', bannerClass: 'banner-grille-pastel', desc: 'Grille aux couleurs pastel douces', hidden: true },
  // Effets animés
  { id: 'banner_flammes', name: '🔥 Effet Flammes', price: 75000, type: 'banner', bannerClass: 'banner-flammes', desc: 'Des flammes dansent au bas de ta carte !', hidden: true },
  { id: 'banner_neige', name: '❄️ Effet Neige', price: 75000, type: 'banner', bannerClass: 'banner-neige', desc: 'Des flocons tombent doucement sur ta carte', hidden: true },
];
